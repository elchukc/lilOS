FILES = ./build/kernel.asm.o ./build/kernel.o ./build/loader/formats/elf.o ./build/loader/formats/elfloader.o ./build/isr80h/isr80h.o ./build/isr80h/misc.o ./build/isr80h/io.o ./build/isr80h/heap.o ./build/isr80h/process.o ./build/keyboard/keyboard.o ./build/keyboard/classic.o ./build/disk/disk.o ./build/disk/streamer.o ./build/task/process.o ./build/task/tss.asm.o ./build/task/task.asm.o ./build/task/task.o ./build/fs/pparser.o ./build/fs/file.o ./build/fs/fat/fat16.o ./build/string/string.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/gdt/gdt.asm.o ./build/gdt/gdt.o ./build/memory/memory.o ./build/io/io.asm.o ./build/memory/heap/heap.o ./build/memory/heap/kheap.o ./build/memory/paging/paging.o ./build/memory/paging/paging.asm.o
INCLUDES = -I./src
...
all: ./bin/boot.bin ./bin/kernel.bin user_programs
	...
	sudo mount -t vfat ./bin/os.bin /mnt/d # make sure /mnt/d exists
	# Copy a file over
